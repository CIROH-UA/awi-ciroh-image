""" Functions for testing the fitness of a CCEA """
...
def calc_fitness(clause: conjunctive_clause.ConjunctiveClause, fitness_function: Callable,) -> float:
    """ Calculates the fitness of a conjunctive clause using the provided fitness function
...
def child_fitness(clause: conjunctive_clause.ConjunctiveClause,
                  fitness_function: Callable,
                  fitness_threshold: float,
                  max_order: int,
                  use_sensitivity: bool,
                  sensitivity_threshold: float = -np.inf) -> str:
    """ Determine the fitness of a CC clause and return its expected fate.
...
def children_fitness(children: [conjunctive_clause.ConjunctiveClause],
                     fitness_function: Callable,
                     fitness_thresholds: list[float],
                     max_order: int,
                     use_sensitivity: bool = False,
                     sensitivity_threshold: float = -np.inf) -> list:
    """ Determines the fitness and the fate of all CC clauses in a list.  Calls :function:`child_fitness()`
